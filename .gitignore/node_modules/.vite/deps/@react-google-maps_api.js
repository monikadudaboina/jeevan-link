...
function requireInvariant() {
	...
	*/
	...
	invariant_1 = function invariant(condition, format, a, b, c, d, e, f) {
...
var invariant = /*@__PURE__*/ getDefaultExportFromCjs$1(requireInvariant());
...
function registerEvents(props, instance, eventMap) {
	return reduce(eventMap, function reducer(acc, googleEventName, onEventName) {
...
function LoadScriptNext(_ref) {
	...
	var { isLoaded, loadError } = useLoadScript(_objectWithoutProperties(_ref, _excluded$1));
...
var isEqual = /*@__PURE__*/ getDefaultExportFromCjs(function equal(a, b) {
	if (a === b) return true;
...
function MarkerClustererFunctional(props) {
	...
	(0, import_react.useEffect)(() => {
		if (!map) return;
		var clusterer = new Clusterer(map, [], _objectSpread$c({}, options || defaultOptions$4));
...
var equal = /*@__PURE__*/ getDefaultExportFromCjs$1(requireFastDeepEqual());
var ARRAY_TYPES = [
	Int8Array,
	Uint8Array,
	Uint8ClampedArray,
	...
	_appendLeaves(result, clusterId, limit, offset, skipped) {
		for (var child of this.getChildren(clusterId)) {
			...
			if (props && props.cluster) {
				if (skipped + props.point_count <= offset) skipped += props.point_count;
...
function useGoogleMarkerClusterer(options) {
	...
	(0, import_react.useEffect)(() => {
		if (map && markerClusterer === null) setMarkerClusterer(new MarkerClusterer(_objectSpread$a(_objectSpread$a({}, options), {}, { map })));
	}, [map]);
	return markerClusterer;
}
...
function createOverlay(container, pane, position, bounds, getPixelPositionOffset) {
	class Overlay extends google.maps.OverlayView {
		...
		draw() {
			var layoutStyles = getLayoutStyles(this.getProjection(), _objectSpread$3({}, this.container ? getOffsetOverride(this.container, getPixelPositionOffset) : {
				x: 0,
				y: 0
...
var OverlayView = class extends import_react.PureComponent {
	constructor(props) {
		...
		_defineProperty(this, "onPositionElement", () => {
			var layoutStyles = getLayoutStyles(this.overlayView.getProjection(), _objectSpread$2({
				x: 0,
				y: 0
			}, this.containerRef.current ? getOffsetOverride(this.containerRef.current, this.props.getPixelPositionOffset) : {}), this.props.bounds, this.props.position);
